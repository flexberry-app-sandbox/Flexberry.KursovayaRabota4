...
moduleForModel('i-i-s-kursovaya-rabota-4-спр-должность', 'Unit | Serializer | i-i-s-kursovaya-rabota-4-спр-должность', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-kursovaya-rabota-4-спр-должность',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
